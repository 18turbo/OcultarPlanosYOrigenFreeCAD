...
4. Pon un nombre para la macro, por ejemplo: "Ocultar Planos y Origen", y pincha en Aceptar.
5. Aparecerá una pestaña de FreeCAD en blanco.
6. Copia el contenido del fichero **OcultarPlanosYOrigenEjesPart_v.0.9.2.FCMacro** y peǵalo a la ventana en blanco. Para hacerlo, abre el fichero con cualquier editor de texto, selecciona TODO, cópialo con CTRL-C y pégalo en el documento en blanco con CTRL-V
